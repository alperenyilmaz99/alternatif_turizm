    ...
    <>
      ...
      >
        ...
        <a
          ...
          className="absolute bottom-2 right-2 flex h-8 w-8 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 transition hover:scale-110 hover:bg-[#20bd5a] sm:bottom-4 sm:right-4 sm:h-12 sm:w-12"
        >
          <WhatsAppIcon />
        </a>
      </article>
