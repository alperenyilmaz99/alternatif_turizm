      ...
      >
        ...
        <div className="p-6 sm:p-8">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#25D366]/30 transition hover:bg-[#20bd5a]"
          >
            <WhatsAppIcon />
